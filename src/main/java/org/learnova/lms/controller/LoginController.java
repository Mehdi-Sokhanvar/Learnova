...
//            String token = jwtTokenProvider.createToken((AppUser) authenticate.getPrincipal());
            String token = jwtTokenProvider.createToken(loginService.loadUserByUsername(loginDTO.username()));
