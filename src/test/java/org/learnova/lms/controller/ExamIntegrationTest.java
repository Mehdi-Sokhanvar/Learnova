...
public class ExamIntegrationTest {
    ...
    @Test
    void givenValidExamRequest_whenCreateExam_thenReturns201Created()  throws Exception {
    ...
    @Test
    void givenExistingExam_whenEditExam_thenReturns200Ok() throws Exception {
    ...
    @Test
    void givenExistingExam_whenDeleteExam_thenReturns200Ok() throws Exception {
        ZoneId examZone = ZoneId.of("Asia/Tehran");
    ...
    @Test
    void givenCourseWithExams_whenGetAllExams_thenReturns200OkAndExamsList() throws Exception {
        ZoneId examZone = ZoneId.of("Asia/Tehran");
    ...
    @Test
    void givenActiveExam_whenStudentStartsExam_thenReturns201Created() throws Exception {
        ZoneId examZone = ZoneId.of("Asia/Tehran");
    ...
    @Test
    void  givenExamSessionWithQuestions_whenGetCurrentQuestion_thenReturns200Ok() throws Exception {
