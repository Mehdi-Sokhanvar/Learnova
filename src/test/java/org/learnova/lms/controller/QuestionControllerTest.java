...
class QuestionControllerTest {
    ...
    @Test
    void Create_Succsesfull_Essay_Question() throws Exception {
    ...
    @Test
    void Create_Succesfull_TrueFalse_Question() throws Exception {
        String content = String.format("""
                {
                  "type": "TRUE_FALSE",
                  "dtype": "TRUE_FALSE",
    ...
    @Test
    void Create_Succesfull_MultipleChoice_Question() throws Exception {
        String content = String.format("""
                {
    ...
    @Test
    void delete_Essay_Question()  throws Exception {
    ...
    @Test
    void delete_TrueFalse_Question()  throws Exception {
    ...
    @Test
    void delete_MultipleChoice_Question()  throws Exception {
    ...
    @Test
    void addQuestionTOCourse() {
    }


    @Test
    void deleteQuestionFromExam() {
    }
